<template>
  <div class="bg-gray-100 text-gray-900 tracking-wider text-left leading-normal">
    <nav id="header" class="bg-white fixed w-full z-10 top-0 shadow">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between my-4">
          <div class="pl-4 md:pl-0">
              <a class="flex items-center text-orange-600 text-base xl:text-xl no-underline hover:no-underline font-extrabold" href="#">
                  ...
                  </svg> Tatalaksana Diagnosis Ketidakpatuhan Diabetes Mellitus
              </a>
          </div>
    ...
    <div v-if="!isResumeOpen">
      <div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16">
          ...
          <section class="w-full lg:w-4/5">
            <h1 class="flex items-center font-bold break-normal text-gray-700 px-2 text-xl mt-12 lg:mt-0 md:text-2xl"> Borang </h1>
            <hr class="bg-gray-300 my-12">
            <h2 id='section1' class="font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Identitas Pasien</h2>
            <user-form
              @setPatientInput="setPatientInput"
            ></user-form>
            <hr class="bg-gray-300 my-12">

            <h2 class="font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Masalah Tentang Obat</h2>
            ...
            <h2 class="font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Penggunaan Orbat Herbal</h2>
            ...
            <h2 class="font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Pengaturan Pola Makan</h2>
            ...
            <h2 class="font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Pengaturan Aktifitas Fisik</h2>
            ...
            <h2 class="font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Rekomendasi Akhir dan Identifikasi Masalah</h2>
            ...
            <hr class="bg-gray-300 my-12">
            <h2 class="font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Tindak Lanjut</h2>
            <div id='section7' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
              <blockquote class="border-l-4 border-orange-600 italic my-4 pl-8 md:pl-12">Pastikan bahwa seluruh data sudah terisi dengan benar dan rekomendasi sudah muncul pada halaman ini untuk melanjutkan</blockquote>
              <div class="pt-8">
                <button
                  :disable="!isGoToResumeEnable"
                  :class="[!isGoToResumeEnable
            ...
            <div class="w-full lg:w-4/5 lg:ml-auto text-base md:text-sm text-gray-600 px-4 py-24 mb-12">
              <span class="text-base text-orange-600 font-bold"></span> <a href="#" class="text-base md:text-sm text-orange-600 font-bold no-underline hover:underline">Kembali ke atas</a>
            </div>
          </section>
        </div>
    </div>
