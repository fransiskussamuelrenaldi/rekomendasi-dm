  ...
  <nav id="header" class="bg-white fixed w-full z-10 top-0 shadow">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between my-4">
      <div class="pl-4 md:pl-0">
        <router-link :to="{name: 'entry'}" class="flex items-center text-orange-600 text-base xl:text-xl no-underline hover:no-underline font-extrabold" >
          <svg
      ...
      <div class="pr-0 flex justify-end">
        <div class="flex relative inline-block float-right">
            <div class="relative text-sm">
                <button @click="onMenuClick" class="flex items-center mr-3 shadow bg-yellow-700 hover:bg-yellow-500 focus:shadow-outline focus:outline-none text-white text-sm md:text-base font-bold py-2 px-4 rounded">
                    Menu
                ...
                <div v-if="showMenu" id="userMenu" class="bg-white rounded shadow-md mt-2 mr-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30">
                    <ul class="list-reset">
                        <li>
                          <router-link :to="{name: 'tabel-obat'}">
                            <div class="px-4 py-2 block hover:bg-gray-400 no-underline hover:no-underline">Tabel Informasi Obat</div>
                          </router-link>
                        </li>
                    </ul>
                </div>
